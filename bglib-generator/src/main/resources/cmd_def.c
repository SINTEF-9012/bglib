...
static const struct ble_msg apis[]={
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x3,ble_cls_attributes,ble_cmd_attributes_user_response_id}, 0x822,(ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x0,ble_cls_attclient,ble_cmd_attclient_reserved_id}, 0x0,(ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x2,ble_cls_hardware,ble_cmd_hardware_i2c_read_id}, 0x22,(ble_cmd_handler)ble_default},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x2,ble_cls_hardware,ble_cmd_hardware_i2c_write_id}, 0x82,(ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x4,ble_cls_system,ble_cmd_system_get_counters_id}, 0x2222,	(ble_cmd_handler)ble_rsp_system_get_counters},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x0,ble_cls_system,ble_cmd_system_endpoint_tx_id}, 0x0,	(ble_cmd_handler)ble_rsp_system_endpoint_tx},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x0,ble_cls_attributes,ble_cmd_attributes_user_response_id}, 0x0,	(ble_cmd_handler)ble_rsp_attributes_user_response},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x0,ble_cls_attclient,ble_cmd_attclient_reserved_id}, 0x0,	(ble_cmd_handler)ble_rsp_attclient_reserved},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_evt|0x0,0x2,ble_cls_system,ble_evt_system_endpoint_rx_id}, 0x82,	(ble_cmd_handler)ble_evt_system_endpoint_rx},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_evt|0x0,0x5,ble_cls_attributes,ble_evt_attributes_user_request_id}, 0x442,	(ble_cmd_handler)ble_evt_attributes_user_request},
...
static const struct ble_msg* ble_class_system_evt_handlers[]=
{
	...
	&apis[ble_evt_system_endpoint_rx_idx],
};
...
static const struct ble_msg* ble_class_attclient_rsp_handlers[]=
{
	...
	&apis[ble_rsp_attclient_reserved_idx],
...
{
	{ble_class_system_rsp_handlers,13},
	{ble_class_flash_rsp_handlers,8},
	{ble_class_attributes_rsp_handlers,4},
	...
	{ble_class_hardware_rsp_handlers,13},
	{ble_class_test_rsp_handlers,5},
};
struct ble_class_handler_t ble_class_evt_handlers[ble_cls_last]=
{
	{ble_class_system_evt_handlers,3},
	{ble_class_flash_evt_handlers,1},
	{ble_class_attributes_evt_handlers,2},
