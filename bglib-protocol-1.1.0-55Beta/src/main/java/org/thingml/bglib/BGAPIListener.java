...
public interface BGAPIListener {
	...
	void receive_system_endpoint_tx(int result);
	...
	void receive_system_endpoint_rx(int result, byte[] data);
	void receive_system_endpoint_set_watermarks(int result);
	...
	void receive_system_endpoint_watermark_rx(int endpoint, int data);
	void receive_system_endpoint_watermark_tx(int endpoint, int data);
	void receive_system_script_failure(int address, int reason);
	...
	void receive_attributes_user_read_response();
	void receive_attributes_user_write_response();
	void receive_attributes_value(int connection, int reason, int handle, int offset, byte[] value);
	void receive_attributes_user_read_request(int connection, int handle, int offset, int maxsize);
	void receive_attributes_status(int handle, int flags);
	...
	void receive_attclient_indicate_confirm(int result);
	...
	void receive_hardware_timer_comparator(int result);
	...
	void receive_test_debug(byte[] output);
