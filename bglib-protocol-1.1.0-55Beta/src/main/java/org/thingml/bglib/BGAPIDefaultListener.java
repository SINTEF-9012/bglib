...
public class BGAPIDefaultListener implements BGAPIListener {
	...
	public void receive_system_get_counters(int txok, int txretry, int rxok, int rxfail, int mbuf) {}
	...
	public void receive_system_endpoint_tx(int result) {}
	...
	public void receive_system_endpoint_rx(int result, byte[] data) {}
	public void receive_system_endpoint_set_watermarks(int result) {}
	...
	public void receive_system_endpoint_watermark_rx(int endpoint, int data) {}
	public void receive_system_endpoint_watermark_tx(int endpoint, int data) {}
	public void receive_system_script_failure(int address, int reason) {}
	...
	public void receive_attributes_user_read_response() {}
	public void receive_attributes_user_write_response() {}
	public void receive_attributes_value(int connection, int reason, int handle, int offset, byte[] value) {}
	public void receive_attributes_user_read_request(int connection, int handle, int offset, int maxsize) {}
	public void receive_attributes_status(int handle, int flags) {}
	...
	public void receive_attclient_indicate_confirm(int result) {}
	...
	public void receive_hardware_timer_comparator(int result) {}
	...
	public void receive_test_debug(byte[] output) {}
